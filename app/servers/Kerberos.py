    ...
    def handle(self):
        ...
        try:
            ...
            if KerbHash:
                ...
                output_data.append(f"[KERB-TCP] Hash captured: {KerbHash} from {self.client_address[0]}")
            else:
                output_data.append(f"[KERB-TCP] No Kerberos hash captured from {self.client_address[0]}")
                
        except Exception as e:
            output_data.append(f"[KERB-TCP] Error handling request: {e}")
    ...
    def handle(self):
        ...
        try:
            ...
            if KerbHash:
                ...
                output_data.append(f"[KERB-UDP] Hash captured: {KerbHash} from {self.client_address[0]}")
            else:
                output_data.append(f"[KERB-UDP] No Kerberos hash captured from {self.client_address[0]}")

        except Exception as e:
            output_data.append(f"[KERB-UDP] Error handling request: {e}")
